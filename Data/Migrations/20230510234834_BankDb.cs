        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccountId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountHolderCustomerId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoanId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountId = table.Column<int>(type: "int", nullable: false),
                    InterstRate = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankBranchBranchId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_BankBranches_BankBranchBranchId",
                        column: x => x.BankBranchBranchId,
                        principalTable: "BankBranches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_AccountHolderCustomerId",
                table: "Accounts",
                column: "AccountHolderCustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_BankBranchBranchId",
                table: "Employees",
                column: "BankBranchBranchId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Accounts_Customers_AccountHolderCustomerId",
                table: "Accounts",
                column: "AccountHolderCustomerId",
